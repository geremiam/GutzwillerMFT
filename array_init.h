...
double LinInitArray(const double xMin, const double xMax, const int NumPts, double*const Array, const bool endpoint=false);
float  LinInitArray(const float  xMin, const float  xMax, const int NumPts, float*const  Array, const bool endpoint=false);
